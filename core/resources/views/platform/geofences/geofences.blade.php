       ...
       <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('global.geofences') }}</a>
          </div>

          <div class="collapse navbar-collapse" id="bs-title-navbar">

            <div class="navbar-form navbar-right">
                <a href="#/geofence/new" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> {{ trans('global.new_geofence') }}</a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="{{ url('platform/geofences/export?type=xls') }}">Excel5 (xls)</a></li>
                  <li><a href="{{ url('platform/geofences/export?type=xlsx') }}">Excel2007 (xlsx)</a></li>
                  <li><a href="{{ url('platform/geofences/export?type=csv') }}">CSV</a></li>
                </ul>
              </li>
            </ul>
...
var geofences_table = $('#dt-table-geofences').DataTable({
  ajax: "{{ url('platform/geofences/data') }}",
  order: [
    [0, "asc"],
    [1, "asc"]
  ],
...
$('#dt-table-geofences tbody').on('click dblclick', 'tr', function(e) {
    ...
    if(td_index == 2 || td_index == 4) return;
...
$('#dt-table-geofences').on('click', '.row-btn-delete', function() {
  ...
  function(){
    ...
    var jqxhr = $.ajax({
      url: "{{ url('platform/geofence/delete') }}",
