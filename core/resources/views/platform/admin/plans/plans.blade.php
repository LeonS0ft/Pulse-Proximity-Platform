        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-title-navbar">
            ...
            <div class="navbar-form navbar-right">
                <a href="#/admin/plan" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> {{ trans('global.new_plan') }}</a>
            </div>
    ...
    },
    {
      render: function (data, type, row) {
        ...
        return '<div class="row-actions-wrap"><div class="text-center row-actions" data-sl="' + data + '">' + 
          '<a href="#/admin/plan/' + data + '" class="btn btn-xs btn-success row-btn-edit" data-toggle="tooltip" title="{{ trans('global.edit') }}"><i class="fa fa-pencil"></i></a> ' + 
