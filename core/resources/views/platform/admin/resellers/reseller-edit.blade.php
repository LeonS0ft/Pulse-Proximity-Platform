<div class="container">
      ...
      <nav class="navbar navbar-default card-box sub-navbar">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand no-link" href="javascript:void(0);">\</a>
            <a class="navbar-brand no-link" href="javascript:void(0);">{{ trans('global.edit_reseller') }}</a>
          </div>
        </div>
      </nav>
    </div>
  ...
  <form class="ajax" id="frm" method="post" action="{{ url('platform/admin/reseller/update') }}">
        ...
        <div class="panel panel-default">
          ...
          <fieldset class="panel-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" value="{{ $reseller->name }}" required autocomplete="off">
            </div>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="domain" name="domain" value="{{ $reseller->domain }}" required autocomplete="off">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              $account_owner = Former::select( 'user_id' )->addOption( '&nbsp;' )->class( 'select2-required form-control' )->name( 'user_id' )->forceValue( $user->id )->fromQuery( $users, 'email', 'id' )->required( true )->label( trans( 'global.account_owner' ) );

              if ( $user->id == 1 )$account_owner->disabled( true );
            ...
            <div class="form-group">
              <div class="checkbox checkbox-primary">
                <input name="active" id="active" type="checkbox" value="1" <?php if($reseller->active == 1) echo ' checked'; ?>>
            ...
            <fieldset>
              ...
              <div id="mailgun_div">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="mail_mailgun_domain" id="mail_mailgun_domain" value="{{ $reseller->mail_mailgun_domain }}" autocomplete="off">
                </div>

                <div class="form-group">
                  <label for="mail_mailgun_secret">{{ trans('global.mailgun_secret') }}</label>
                  <input type="text" class="form-control" name="mail_mailgun_secret" id="mail_mailgun_secret" value="{{ $reseller->mail_mailgun_secret }}" autocomplete="off">
                </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="mail_from_name" id="mail_from_name" value="{{ $reseller->mail_from_name }}" autocomplete="off">
              </div>

              <div class="form-group">
                <label for="mail_from_address">{{ trans('global.sender_address') }}</label>
                <input type="text" class="form-control" name="mail_from_address" id="mail_from_address" value="{{ $reseller->mail_from_address }}" autocomplete="off">
              </div>


              <div class="form-group">
                <label for="mail_host">{{ trans('global.host') }}</label>
                <input type="text" class="form-control" name="mail_host" id="mail_host" value="{{ $reseller->mail_host }}" autocomplete="off">
              </div>

              <div class="form-group">
                <label for="mail_port">{{ trans('global.port') }}</label>
                <input type="number" class="form-control" name="mail_port" id="mail_port" value="{{ $reseller->mail_port }}" autocomplete="off">
              </div>

              <div class="form-group">
                <?php
                echo Former::select( 'mail_encryption' )->class( 'select2-required form-control' )->name( 'mail_encryption' )->forceValue( $reseller->mail_encryption )->options( [ '' => '&nbsp;', 'tls' => 'tls', 'ssl' => 'ssl' ] )->label( trans( 'global.encryption' ) );
                ?>
              </div>

              <div class="form-group">
                <label for="mail_username">{{ trans('global.username') }}</label>
                <input type="text" class="form-control" name="mail_username" id="mail_username" value="{{ $reseller->mail_username }}" autocomplete="off">
              </div>

              <div class="form-group">
                <label for="mail_password">{{ trans('global.password') }}</label>
                <input type="text" class="form-control" name="mail_password" id="mail_password" value="{{ $reseller->mail_password }}" autocomplete="off">
              </div>
          ...
          <div class="tab-pane" id="avangate">
            <fieldset>
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="avangate_key" id="avangate_key" value="{{ $reseller->avangate_key }}" autocomplete="off">
              </div>
            </fieldset>
          </div>
